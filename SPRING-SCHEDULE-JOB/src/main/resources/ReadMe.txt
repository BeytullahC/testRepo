-Project.properties dosyasını kendi db ne göre düzenle.
-projenin pom.xml'ine mysql yerine kendi db jarını ekle.
-Aşağıda job ın zamanlanmasıyla ilgili açıklamalar var.
